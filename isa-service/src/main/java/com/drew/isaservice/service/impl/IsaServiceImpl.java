...
public class IsaServiceImpl implements IsaService {
    private static final Logger log = Logger.getLogger(IsaServiceImpl.class);
    ...
    private Isa getOrCreateIsaTracker(String keycloakId) {
        return isaRepository.findByKeycloakIdAndTaxYear(keycloakId, currentTaxYear)
                .orElseGet(() -> {
                    ...
                    newIsaTracker.setCashIsaPaidInTotal(BigDecimal.ZERO);
                    newIsaTracker.setCashIsaWithdrawnTotal(BigDecimal.ZERO);
                    newIsaTracker.setCashIsaBalance(BigDecimal.ZERO);
                    newIsaTracker.setStocksSharesIsaPaidInTotal(BigDecimal.ZERO);
                    newIsaTracker.setStocksSharesIsaWithdrawnTotal(BigDecimal.ZERO);
                    newIsaTracker.setStocksSharesIsaBalance(BigDecimal.ZERO);
                    newIsaTracker.setInnovativeFinanceIsaPaidInTotal(BigDecimal.ZERO);
                    newIsaTracker.setInnovativeFinanceIsaWithdrawnTotal(BigDecimal.ZERO);
                    newIsaTracker.setInnovativeFinanceIsaBalance(BigDecimal.ZERO);
                    newIsaTracker.setLifetimeIsaPaidInTotal(BigDecimal.ZERO);
                    newIsaTracker.setLifetimeIsaWithdrawnTotal(BigDecimal.ZERO);
                    newIsaTracker.setLifetimeIsaBalance(BigDecimal.ZERO);
                    newIsaTracker.setTaxYearIn(BigDecimal.ZERO);
                    newIsaTracker.setTaxYearWithdrawn(BigDecimal.ZERO);
                    newIsaTracker.setTaxYearBalance(BigDecimal.ZERO);
